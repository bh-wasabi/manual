...
- Nota: cuando la expresión puede regresar múltiples resultados, hay que poner la palabra reservada "return" antes, por ejemplo: `=if (a>b) {return a} else {return b}`
